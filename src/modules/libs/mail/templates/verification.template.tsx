                ...
                <Body className='max-w-2xl mx-auto p-6 bg-slate-50'>
                    <Section className='text-center mb-8'>
                        ...
                        <Text className='text-base text-black'>
                            Спасибо за регистрацию в Beaverstream! Чтобы подтвердить свой адрес электронной почты, пожалуйста, перейдите по следующей ссылке:
                        </Text>
                    ...
                    <Section className='text-center mt-8'>
                        <Text className='text-gray-600'>
                            ...
                            <Link href="mailto:bobrovskii.nikita1471@gmail.com" className="text-[#18b9ae] underline">
                                bobrovskii.nikita1471@gmail.com
                            </Link>
                        </Text>
                    </Section>
                </Body>
